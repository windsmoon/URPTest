...
half3 GetLighting(LightData_CelPBR lightData, Surface_CelPBR surface, BRDF_CelPBR brdf, GI_CelPBR gi, TempData_CelPBR tempData)
{
    return (brdf.diffuse + brdf.specular) * lightData.color * lightData.distanceAttenuation * lightData.shadowAttenuation * tempData.nDotL + gi.diffuseColor + gi.specularColor;
