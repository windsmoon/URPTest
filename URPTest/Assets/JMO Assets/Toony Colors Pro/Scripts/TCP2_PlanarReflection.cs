	...
	namespace Runtime
	{
		...
		public class TCP2_PlanarReflection : MonoBehaviour
		{
			...
			void UpdateRenderTexture()
			{
				...
				reflectionRenderTexture = new RenderTexture(textureSize, textureSize, 16, RenderTextureFormat.Default, RenderTextureReadWrite.sRGB);
			...
			void UpdateCommandBuffer()
			{
				...
				commandBufferBlur = new CommandBuffer();
				{
					...
					commandBufferBlur.GetTemporaryRT(tempRT, textureSize, textureSize, 16, FilterMode.Bilinear, RenderTextureFormat.Default, RenderTextureReadWrite.sRGB);
...
#endif
			{
				...
				var oldpos = worldCamera.transform.position;
				...
				var projection = worldCamera.CalculateObliqueMatrix(clipPlane);
				...
				var euler = worldCamera.transform.eulerAngles;
